		...
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				...
				<el-form-item label="校区名称" prop="campus_name">
						...
						v-if="user_group === '管理员' || (form_sub['student_id'] && $check_field('set','campus_name')) || (!form_sub['student_id'] && $check_field('add','campus_name'))">
				...
				<el-form-item label="班级名称" prop="class_name">
								<el-select id="class_name" v-model="form_sub['class_name']"
						v-if="user_group === '管理员' || (form_sub['student_id'] && $check_field('set','class_name')) || (!form_sub['student_id'] && $check_field('add','class_name'))">
						<el-option v-for="o in list_class_name" :key="o['class_name']" :label="o['class_name']"
							:value="o['class_name']">
						</el-option>
					</el-select>
					<div v-else-if="$check_field('get','class_name')">{{form_sub['class_name']}}</div>
							</el-form-item>
			</el-col>
				...
				<el-form-item label="年级名称" prop="grade_name">
								<el-select id="grade_name" v-model="form_sub['grade_name']"
						v-if="user_group === '管理员' || (form_sub['student_id'] && $check_field('set','grade_name')) || (!form_sub['student_id'] && $check_field('add','grade_name'))">
						<el-option v-for="o in list_grade_name" :key="o['grade_name']" :label="o['grade_name']"
							:value="o['grade_name']">
						</el-option>
					</el-select>
					<div v-else-if="$check_field('get','grade_name')">{{form_sub['grade_name']}}</div>
							</el-form-item>
			</el-col>
