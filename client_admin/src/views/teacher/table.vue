	...
	<el-main class="bg table_wrap">
		<el-form label-position="right" :model="query" class="form p_4" label-width="120">
			<el-row>
					...
					<el-form-item label="工号">
									<el-input v-model="query.job_no"></el-input>
								</el-form-item>
				</el-col>
															<el-col :xs="24" :sm="24" :lg="8" class="el_form_search_wrap">
					...
					<el-form-item>
						...
						<router-link v-if="user_group == '管理员' || $check_action('/teacher/table','add') || $check_action('/teacher/view','add')" class="el-button el-button--default el-button--primary search_btn_add" to="./view?">添加
						</router-link>
            			<el-button v-if="user_group == '管理员' || $check_action('/teacher/table','del') || $check_action('/teacher/view','del')" class="search_btn_del" type="danger" @click="delInfo()">删除</el-button>
					</el-form-item>
				</el-col>
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			...
			<el-table-column prop="username" label="用户名" width="120">
				...
				<el-table-column prop="job_no" @sort-change="$sortChange" label="工号"
				v-if="user_group == '管理员' || $check_field('get','job_no')" min-width="200">
					</el-table-column>
			...
			<el-table-column fixed="right" label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/teacher/table','set') || $check_action('/teacher/view','set') || $check_action('/teacher/view','get') || $check_action('/${table.tableConfig.table_nav_name}/table','add') || $check_action('/${table.tableConfig.table_nav_name}/view','add')" >


				<template slot-scope="scope">
					<router-link class="el-button el-button--small is-plain el-button--success" style="margin: 5px !important;"
					v-if="user_group == '管理员' || $check_action('/teacher/table','set') || $check_action('/teacher/view','set') || $check_action('/teacher/view','get')"
	...
	export default {
		...
		data() {
			return {
				...
				showModal: false,
				// 获取数据地址
				url_get_list: "~/api/teacher/get_list?like=0",
				url_del: "~/api/teacher/del?",
